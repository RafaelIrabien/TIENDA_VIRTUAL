<?php 
    include_once "template-principal/header.php";
 ...
 ?>
    ...
    <section class="bg-light">
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <?php 
                    foreach($data['nuevosProductos'] as $productoN) {
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <?php echo $productoN['descripcion']; ?>
                            </p>
    ...
    <?php 
        include_once "template-principal/footer.php";
