                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted">
                                        <strong>
                                            <?php echo $data['producto']['categoria']; ?>
                                        </strong>
                                    </p>
                                </li>
                            </ul>
                                        ...
                                        <ul class="list-inline pb-3">
                                            ...
                                            <li class="list-inline-item">
                                                <span class="badge bg-secondary" id="var-value">
                                                    <?php echo $data['producto']['cantidad']; ?>
                                                </span></li>
                        ...
                        <div class="card rounded-0">
                            ...
                            <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    ...
                                    <li><a class="btn btn-success text-white mt-2" href="<?php echo BASE_URL . 'principal/detail/' . $relacionado['id_producto']; ?>"><i class="far fa-eye"></i></a></li>
                                    <li><a class="btn btn-success text-white mt-2" href="shop-single.html"><i class="fas fa-cart-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <a href="<?php echo BASE_URL . 'principal/detail/' . $relacionado['id_producto']; ?>" class="h3 text-decoration-none"><?php echo $relacionado['nombre']; ?></a>
                            ...
                            <p class="text-center mb-0"><?php echo MONEDA . ' ' . $relacionado['precio']; ?></p>
                        </div>
                    </div>
                </div>
